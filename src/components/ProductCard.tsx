      ...
      <div className="p-4">
        ...
        <div className="flex gap-2">
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-1.5 px-3 py-2.5 min-h-[44px] rounded-lg text-xs font-semibold transition-all disabled:opacity-40 disabled:cursor-not-allowed ${
          ...
          <Link
            ...
            className="px-3 py-2.5 min-h-[44px] inline-flex items-center border border-border text-foreground rounded-lg text-xs font-semibold hover:bg-muted transition-colors"
          >
